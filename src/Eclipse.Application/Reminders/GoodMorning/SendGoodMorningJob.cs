...
internal sealed class SendGoodMorningJob : IJob
{
    private readonly ICurrentCulture _currentCulture;

    private readonly IStringLocalizer<SendGoodMorningJob> _localizer;

    private readonly ITelegramBotClient _client;

    private readonly IUserRepository _userRepository;

    private readonly ILogger<SendGoodMorningJob> _logger;

    public SendGoodMorningJob(
        ICurrentCulture currentCulture,
        IStringLocalizer<SendGoodMorningJob> localizer,
        ITelegramBotClient client,
        IUserRepository userRepository,
        ILogger<SendGoodMorningJob> logger)
    {
    ...
    public async Task Execute(IJobExecutionContext context)
    {
        ...
        var args = JsonConvert.DeserializeObject<SendGoodMorningJobData>(data);
