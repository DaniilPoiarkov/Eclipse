...
internal sealed class LegacyPipelineProvider : IPipelineProvider
{
    ...
    public LegacyPipelineProvider(IEnumerable<PipelineBase> pipelines, IServiceProvider serviceProvider)
    {
    ...
    private bool Validate(PipelineBase pipeline, out ValidationResult[] results)
    {
        ...
        var context = new ValidationContext(scope.ServiceProvider, null!);
